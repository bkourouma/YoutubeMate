...
Rules: write viewer-facing copy in ${language}; produce exactly 3 alternative titles, each under 100 characters, scored 1-100 on click potential with a one-line reason, ranked best first; write one description of 2 to 3 sentences; produce exactly 8 specific tags; produce exactly 3 genuinely distinct thumbnail concepts, each with a detailed English image prompt composed for a 9:16 vertical YouTube Shorts thumbnail, subject and essential text kept in the central area, no logo, no watermark and no lettering because headline text is added separately. The scores are your own editorial estimate: never present them as data from an analytics account. Never invent figures, prices, links, offers, results or guarantees that were not supplied.`;
